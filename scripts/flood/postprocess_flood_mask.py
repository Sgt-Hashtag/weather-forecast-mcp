...
Inputs:
  - prithvi_flood_input.tif: 13-band Sentinel-2 stack from flood/copernicus_flood_segmentation.py
  - prithvi_flood_prediction.tif: raw model mask from flood/prithvi_flood_inference.py

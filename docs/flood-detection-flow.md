...
```bash
scripts/prithvi_flood_seg/run_flood_detection_pipeline.sh
```

Optional tuning:

```bash
DEVICE=cuda NDVI_MAX=0.12 MNDWI_MIN=0.05 NDWI_MIN=0.0 MIN_AREA=30 scripts/prithvi_flood_seg/run_flood_detection_pipeline.sh
```
...
outputs are written back to `scripts/prithvi_flood_seg/`.
...
```text
scripts/prithvi_flood_seg/prithvi_flood_input.tif
```
...
```bash
python3 scripts/prithvi_flood_seg/prithvi2_flood_inference.py --device auto
```
...
```bash
python3 scripts/prithvi_flood_seg/postprocess_flood_mask.py --raw-mask scripts/prithvi_flood_seg/prithvi2_flood_prediction.tif
```

### 3. Postprocess Flood Mask

```bash
python3 scripts/prithvi_flood_seg/postprocess_flood_mask.py
```

Creates:

```text
scripts/prithvi_flood_seg/prithvi_flood_prediction_filtered.tif
scripts/prithvi_flood_seg/prithvi_flood_prediction_filtered_preview.png
```
